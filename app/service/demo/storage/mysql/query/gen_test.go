...
func Test_WithContext(t *testing.T) {
	...
	for _, ctx := range []context.Context{
		qCtx.Block.UnderlyingDB().Statement.Context,
		qCtx.BlockTransaction.UnderlyingDB().Statement.Context,
		qCtx.ChainClient.UnderlyingDB().Statement.Context,
		qCtx.ChainInfo.UnderlyingDB().Statement.Context,
		qCtx.ChainMetric.UnderlyingDB().Statement.Context,
