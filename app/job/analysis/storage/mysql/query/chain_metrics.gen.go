...
func newChainMetric(db *gorm.DB, opts ...gen.DOOption) chainMetric {
	...
	_chainMetric.TxPending = field.NewInt64(tableName, "tx_pending")
	_chainMetric.TokenPriceUsd = field.NewFloat64(tableName, "token_price_usd")
...
type chainMetric struct {
	...
	TxTps             field.Float64
	TxTpd             field.Float64
	TxPending         field.Int64
	TokenPriceUsd     field.Float64
...
func (c *chainMetric) updateTableName(table string) *chainMetric {
	...
	c.TxPending = field.NewInt64(table, "tx_pending")
	c.TokenPriceUsd = field.NewFloat64(table, "token_price_usd")
...
func (c *chainMetric) fillFieldMap() {
	...
	c.fieldMap["tx_pending"] = c.TxPending
	c.fieldMap["token_price_usd"] = c.TokenPriceUsd
